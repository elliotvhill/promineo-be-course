...
```sql
SELECT * FROM city JOIN country USING (country_id) LIMIT 5;

-- Instructor solution:
SELECT * FROM city
INNER JOIN country USING (country_id) LIMIT 5;
```
...
```sql
SELECT city, country FROM city JOIN country USING (country_id) LIMIT 5;
