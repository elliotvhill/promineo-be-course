...
public class Menu {
  ...
  private int collectIntSelection(String message) {
    System.out.print(message + ": ");
    String line = scanner.nextLine(); // Use nextLine here bc nextInt would not return the "\n" character (used as the command in the exitMenu test) -- generally use nextLine with Scanners
