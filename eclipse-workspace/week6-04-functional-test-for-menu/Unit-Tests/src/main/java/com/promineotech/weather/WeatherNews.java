...
public class WeatherNews {
  ...
  private static final Float LOW_ALERT_TRIGGER = 20.0F; // the 'F' signals it's a float, not a double
   ...
   */
  @VisibleForTesting
  Weather retrieveWeatherFromService() { // package-level access/scope
