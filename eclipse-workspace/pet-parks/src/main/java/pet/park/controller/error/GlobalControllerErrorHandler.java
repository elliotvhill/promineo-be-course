...
public class GlobalControllerErrorHandler {
	...
	private enum LogStatus {
		// specify whether we want to log the entire stack trace or the message only
	...
	// WebRequest will allow Spring to get the uri of the request
	@ExceptionHandler(NoSuchElementException.class)
	@ResponseStatus(code = HttpStatus.NOT_FOUND) // changes the response status to the one we want
